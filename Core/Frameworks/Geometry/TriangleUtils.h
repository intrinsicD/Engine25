...
/**
    ...
    /**
     * @brief Calculates the area of a triangle using a numerically stable version of Heron's formula.
     ...
     */
    Vector<Real, 3>
    ToBarycentricCoordinates(const Vector<Real, 3> &p, const Vector<Real, 3> &u, const Vector<Real, 3> &v,
     ...
     */
    Vector<Real, 3>
    FromBarycentric(const Vector<Real, 3> &barycentric, const Vector<Real, 3> &u, const Vector<Real, 3> &v,
                    const Vector<Real, 3> &w);
}
